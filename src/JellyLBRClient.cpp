...
//******************************************************************************
void JellyLBRClient::onStateChange(ESessionState oldState, ESessionState newState)
{
...
void JellyLBRClient::monitor()
{
   LBRClient::monitor();
}

void JellyLBRClient::waitForCommand()
{
